...
export const MyUserContextProvider = (props: Props) => {
  ...
  const getUserDetails = async (): Promise<{ data: UserDetails | null; error: string | null }> => {
  ...
  const getSubscription = async (): Promise<{ data: Subscription | null; error: string | null }> => {
    const { data, error } = await supabase
      .from('subscriptions')
